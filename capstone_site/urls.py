...
urlpatterns = [
    ...
    path('matching/', _matching_redirect, {'default_tab': 'matching'}, name='matching_redirect_root'),
    re_path(r'^matching/.*$', _matching_redirect, {'default_tab': 'matching'}, name='matching_redirect'),
