...
urlpatterns = [
    ...
    path('matching/recommendations/', mentee_recommendations, name='api-matching-recommendations'),
    ...
    path('auth/forgot-password/', auth_forgot_password, name='api-auth-forgot-password'),
    path('auth/password-reset-confirm/', auth_password_reset_confirm, name='api-auth-password-reset-confirm'),
    path('auth/google/', auth_google, name='api-auth-google'),
    ...
    path('user/preferences/', user_preferences, name='api-user-preferences'),
    ...
    path('me/password-code/send/', send_password_change_code, name='api-me-password-code-send'),
    ...
    path('questionnaire/options/', questionnaire_options, name='api-questionnaire-options'),
    ...
    path('topics/create/', topic_create, name='api-topics-create'),
    ...
    path('posts/<int:post_id>/share/', post_share, name='api-posts-share'),
